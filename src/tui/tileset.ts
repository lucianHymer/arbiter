 ...
 */
export async function loadTileset(): Promise<Tileset> {
 ...
 */
export function extractTile(tileset: Tileset, index: number): RGB[][] {
 ...
 */
export function compositeTiles(fg: RGB[][], bg: RGB[][], alphaThreshold: number): RGB[][] {
 ...
 */
export function renderTile(pixels: RGB[][]): string[] {
  const lines: string[] = [];
